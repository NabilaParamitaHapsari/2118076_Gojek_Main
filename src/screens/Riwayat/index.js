...
import { Clock, SearchNormal1, ProfileCircle, Wallet3, CardSend, MoreCircle, Home, Car, ShoppingBag, Shop, Notification } from 'iconsax-react-native';
  ...
  return (
    <View style={styles.container}>
      <View style={styles.header}>
        <Text style={{ color: 'black', fontSize: 20, fontWeight: 'bold' }}>Riwayat Pesanan</Text>
      </View> 
      <ScrollView>
        <Main />
      </ScrollView>
  ...
  return (
    <View style={home.container}>
      <ScrollView horizontal style={{ paddingHorizontal: 20 }} showsHorizontalScrollIndicator={false}>
        ...
        <View style={{ backgroundColor: 'lightgrey', padding: 10, borderRadius: 25, marginHorizontal: 5}}>
          <Text style={{ color: 'black' }}>GO-SEND</Text>
        </View>
      </ScrollView>
      <View style={{ paddingHorizontal: 20, marginTop: 20, }}>
        ...
        <View style={{ flexDirection: 'row', alignItems: 'center' }}>
          ...
          <View style={{ flexDirection: 'row', flex: 1, justifyContent: 'space-between', alignItems: 'center' }}>
            <Text style={{ color: 'black', fontSize: 16, fontWeight: 'bold', paddingLeft: 10, }}>Tujuan : Apotik Karanglo</Text>
      ...
      <View style={{ paddingHorizontal: 20, marginTop: 20, }}>
        ...
        <View style={{ flexDirection: 'row', alignItems: 'center' }}>
          ...
          />
          <View style={{ flexDirection: 'row', flex: 1, justifyContent: 'space-between', alignItems: 'center' }}>
            <Text style={{ color: 'black', fontSize: 16, fontWeight: 'bold', paddingLeft: 10, }}>Tujuan : ITN Malang</Text>
            <Text style={{ color: 'black', fontSize: 14 }}>Rp20.000</Text>
          </View>
        </View>
      </View>
      <View style={{ paddingHorizontal: 20, marginTop: 20, }}>
        <Text style={{ color: 'black', fontSize: 14, }}>12 November, 2023</Text>
        <View style={{ flexDirection: 'row', alignItems: 'center' }}>
          <Image
            source={shopping}
            style={home.icon}
          />
          <View style={{ flexDirection: 'row', flex: 1, justifyContent: 'space-between', alignItems: 'center' }}>
            <Text style={{ color: 'black', fontSize: 16, fontWeight: 'bold', paddingLeft: 10, }}>Lokasi : Jl. Soekarno Hatta</Text>
